 ...
 *
 * @param officeModeTimeProfileId The ID of the office mode time profile
 * @param installationPointId The ID of the installation point
 * @param requestConfig The request configuration (optional).
 */
suspend fun XesarConnect.configureOfficeModeTimeProfileMapi(
    officeModeTimeProfileId: UUID,
    installationPointId: UUID,
    requestConfig: XesarConnect.RequestConfig = buildRequestConfig()
): Deferred<InstallationPointChanged> {
