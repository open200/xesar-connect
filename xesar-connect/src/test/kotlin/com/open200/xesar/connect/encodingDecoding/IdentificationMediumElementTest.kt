...
class IdentificationMediumElementTest :
    FunSpec({
        ...
        val identificationMediumString =
            "{\"requestId\":\"00000000-1281-42c0-9a15-c5844850c748\"," +
                "\"response\":{\"id\":\"8293e920-90ce-48da-851c-cff54a13e2c6\"," +
                "\"label\":\"test door\"," +
                "\"issuedAt\":\"2023-07-05T15:22:13.509825\"," +
                "\"syncedAt\":\"2023-07-05T15:22:38.230076\"," +
                "\"validityDuration\":151," +
                "\"authorizationProfileId\":\"d08fdd62-bc36-4e47-8bc9-62b603e75ed9\"," +
                "\"authorizationProfileName\":\"Authorization Profile 1\"," +
                "\"individualAuthorizationProfileIds\":[\"3dba6935-6904-4bc0-99d3-8115c9bbbedc\"," +
                "\"66b9f5d9-5664-4bb9-9546-af315987752b\"]," +
                "\"mediumState\":\"ACTIVE\"," +
                "\"accessBeginAt\":\"2021-01-01T00:00:00\"," +
                "\"accessEndAt\":\"2021-01-01T00:00:00\"," +
                "\"validityBeginAt\":\"2021-01-01T00:00:00\"," +
                "\"validityEndAt\":\"2021-01-01T00:00:00\"," +
                "\"validityBeginAtInHardware\":\"2021-01-01T00:00:00\"," +
                "\"validityEndAtInHardware\":\"2021-01-01T00:00:00\"," +
                "\"external\":false," +
                "\"disengagePeriod\":\"SHORT\"," +
                "\"mediumIdentifier\":1," +
                "\"outdated\":true," +
                "\"personId\":\"82a8a2cc-5d39-4cfa-b04e-49111a0bcdf7\"," +
                "\"person\":\"test Person\"," +
        ...
        test("decoding QueryResponseElement for an identification medium") {
            val identificationMediumsDecoded =
                decodeQueryElement<IdentificationMedium>(identificationMediumString)

            identificationMediumsDecoded.shouldBeEqual(identificationMedium)
        }
    })
