...
class InstallationPointListTest :
    FunSpec({
        ...
        test("encoding installationPointList for a list of installation Points") {
            ...
            logger.info { installationPointEncoded }
            logger.info { installationPointString }
