    ...
    FunSpec({
        test("set phone number on smartphone media") {
            ...
            runTest {
                ...
                harness.respondTo(Topics.Command.SET_PHONE_NUMBER_ON_SMARTPHONE) {
                    val apiEvent =
                        ApiEvent(
                            ...
                            MediumChanged(
                                ...
                                validUntil = null,
                                changedAt = LocalDateTime.parse("2024-08-08T08:00:40.671784826"),
                ...
                harness
                    .publishedPayload(Topics.Command.SET_PHONE_NUMBER_ON_SMARTPHONE)
                    .shouldBeEqual(
