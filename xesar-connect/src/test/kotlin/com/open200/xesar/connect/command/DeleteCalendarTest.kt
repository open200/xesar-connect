    ...
    FunSpec({
        test("delete calendar") {
            runTest {
                ...
                harness.respondTo(Topics.Command.DELETE_CALENDAR) {
                    val apiEvent =
                        ApiEvent(
                    ...
                    emitMessage(Topics.Event.CALENDAR_DELETED, encodeEvent(apiEvent))
                }

                val api = harness.api
                val result =
                    api.deleteCalendarAsync(UUID.fromString("43edc7cf-80ab-4486-86db-41cda2c7a2cd"))
                        .await()
                result.id.shouldBeEqual(UUID.fromString("43edc7cf-80ab-4486-86db-41cda2c7a2cd"))

                harness
                    .publishedPayload(Topics.Command.DELETE_CALENDAR)
                    .shouldBeEqual(
