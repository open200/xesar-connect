    ...
    FunSpec({
        test("add smartphone to installation") {
            runTest {
                ...
                harness.respondTo(Topics.Command.ADD_SMARTPHONE_TO_INSTALLATION) {
                    val apiEvent =
                        ApiEvent(
                            ...
                            SmartphoneAddedToInstallation(
                                ...
                                sagaId = UUID.fromString("a14d08c0-6f7a-4fc6-8469-be15a3e7b575"),
                                messageLanguage = "en",
                ...
                result.aggregateId.shouldBe(UUID.fromString("43edc7cf-80ab-4486-86db-41cda2c7a2cd"))

                harness
                    .publishedPayload(Topics.Command.ADD_SMARTPHONE_TO_INSTALLATION)
                    .shouldBeEqual(
